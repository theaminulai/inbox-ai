...
<section class="cf7-ai-inbox-screen<?php echo 'flamingo' === $active_tab ? ' cf7-ai-inbox-is-active' : ''; ?>" id="screen-flamingo">
	...
	<div class="cf7-ai-inbox-settings__shell">
		...
		<?php if ( ! $flamingo_active ) : ?>

			<div class="cf7-ai-inbox-card">
				<div class="cf7-ai-inbox-card__body" style="text-align:center;padding:44px 24px;">
					<h2 style="margin:0 0 6px;font-size:16px;"><?php esc_html_e( 'Flamingo is not active', 'cf7-ai-inbox' ); ?></h2>
					<p style="color:var(--text-secondary);font-size:13px;margin:0;"><?php esc_html_e( 'Install and activate the Flamingo plugin to import its captured messages into AI Inbox.', 'cf7-ai-inbox' ); ?></p>
				</div>
			</div>
		...
		<?php else : ?>
			...
			<div>
				<div class="cf7-ai-inbox-wizard__steps">
					<div class="cf7-ai-inbox-wizard__step cf7-ai-inbox-is-active" data-wizard-step="1"><div class="cf7-ai-inbox-wizard__circle">1</div><span><?php esc_html_e( 'Upload', 'cf7-ai-inbox' ); ?></span></div>
					<div class="cf7-ai-inbox-wizard__line"></div>
					<div class="cf7-ai-inbox-wizard__step" data-wizard-step="2"><div class="cf7-ai-inbox-wizard__circle">2</div><span><?php esc_html_e( 'Map Fields', 'cf7-ai-inbox' ); ?></span></div>
					<div class="cf7-ai-inbox-wizard__line"></div>
				...
				<div class="cf7-ai-inbox-card" id="flamingo-panel-1">
					<div class="cf7-ai-inbox-card__body" style="text-align:center;padding:44px 24px 28px;">
						<h2 style="margin:0 0 4px;font-size:16px;"><?php esc_html_e( 'Check for Flamingo Data', 'cf7-ai-inbox' ); ?></h2>
						<p style="color:var(--text-secondary);font-size:13px;margin:0 0 22px;"><?php esc_html_e( 'Select any file to trigger a check for Flamingo messages available to import.', 'cf7-ai-inbox' ); ?></p>
						<div style="display:flex;flex-direction:column;align-items:center;gap:12px;">
							<svg viewBox="0 0 24 24" fill="none" stroke="var(--accent)" stroke-width="1.6" style="width:44px;height:44px;"><path d="M12 16V4M12 4l-4 4M12 4l4 4"/><path d="M4 16v3a2 2 0 002 2h12a2 2 0 002-2v-3"/></svg>
							<div style="display:flex;gap:10px;align-items:center;flex-wrap:wrap;justify-content:center;">
								...
								<input type="file" id="flamingo-file-input" accept=".json,.csv" style="display:none;">
							...
							<div id="flamingo-detected-info" style="display:none;align-items:center;gap:8px;background:var(--conf-good-soft);border:1px solid #BEE7CD;border-radius:8px;padding:10px 14px;font-size:12.5px;color:var(--conf-good);font-weight:600;margin-top:6px;">
				...
				<div class="cf7-ai-inbox-card" id="flamingo-panel-2" style="display:none;">
					<div class="cf7-ai-inbox-card__header"><h2><?php esc_html_e( 'Map Fields', 'cf7-ai-inbox' ); ?></h2><span class="cf7-ai-inbox-card__muted"><?php esc_html_e( 'Choose what to bring in from Flamingo', 'cf7-ai-inbox' ); ?></span></div>
					<div class="cf7-ai-inbox-card__body">
						<div class="cf7-ai-inbox-switch-row"><div><div class="cf7-ai-inbox-switch-row__text"><?php esc_html_e( 'Inbound messages', 'cf7-ai-inbox' ); ?></div><div class="cf7-ai-inbox-switch-row__sub"><?php esc_html_e( 'Mapped to AI Inbox submissions', 'cf7-ai-inbox' ); ?></div></div><div class="cf7-ai-inbox-switch cf7-ai-inbox-is-on" id="flamingo-toggle-messages"></div></div>
				...
				<div class="cf7-ai-inbox-card" id="flamingo-panel-3" style="display:none;">
					...
					<div class="cf7-ai-inbox-card__body">
						<div class="cf7-ai-inbox-info-row"><span><?php esc_html_e( 'Source', 'cf7-ai-inbox' ); ?></span><b><?php esc_html_e( 'Flamingo', 'cf7-ai-inbox' ); ?></b></div>
