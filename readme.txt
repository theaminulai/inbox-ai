...
A full step-by-step user guide is included with the plugin under `wiki/`, and is also browsable online at [Wiki](https://github.com/theaminulai/inbox-ai/tree/main/wiki).
