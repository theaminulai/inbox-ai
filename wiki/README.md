...
Browsable online at: https://github.com/theaminulai/inbox-ai/tree/main/wiki
...
* Let you review everything in one inbox screen and send replies yourself — **the AI never sends anything automatically.**

## Where to find it

After the plugin is active, look in your WordPress admin sidebar under **Contact** (the same menu Contact Form 7 itself uses). You'll see two new items there:

* **AI Inbox** — where submissions show up and where you reply to them.
* **Settings** — where you connect your AI provider and configure everything else.
...
Read these in order the first time you set up the plugin:

1. [Getting Started](01-getting-started.md) — requirements, activation, and a first-time setup checklist.
2. [AI Provider Settings](02-settings-ai-provider.md) — connect OpenAI, Anthropic, or Google.
