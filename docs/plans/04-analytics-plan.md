...
- `api.js` — shared `fetch()`-to-`admin-ajax.php` wrapper (same as the other four plans), reading from `window.inboxaiInboxAdmin` rather than a page-specific global.
